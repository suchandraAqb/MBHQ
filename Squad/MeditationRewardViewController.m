//
//  MeditationRewardViewController.m
//  Squad
//
...
@interface MeditationRewardViewController (){
    UIView *contentView;
    NSArray *actionArray;
...
@implementation MeditationRewardViewController
...
//    streakDict = [[NSDictionary alloc] init];
...
//    [self GetSquadMoreRewards_webServiceCall];
    [self getMeditationStreakData_webServiceCall];
...
-(void)getMeditationStreakData_webServiceCall{//BADGE
    if (Utility.reachable) {
        ...
        NSMutableURLRequest *request = [Utility getRequest:jsonString api:@"GetMeditationStreakData" append:@""forAction:@"POST"];
