...
+ (NSString *)getUrl:(NSString *)api{
    ...
    }else if([api isEqualToString:@"GetJounalPromptofDay"]){
        urlString = [urlString stringByAppendingFormat:@"%@/mindset/GetJounalPromptofDay",base];
    }else if([api isEqualToString:@"UpdateUserJounalPrompt"]){
        urlString = [urlString stringByAppendingFormat:@"%@/mindset/UpdateUserJounalPrompt",base];
    }
