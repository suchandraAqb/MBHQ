...
- (id)initWithAnnotation:(id<MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithAnnotation:annotation reuseIdentifier:reuseIdentifier]) {
        ...
        self.pulseScaleFactor = 2;
        self.pulseAnimationDuration = 1.5;
        self.outerPulseAnimationDuration = 1;
        self.colorDotInset = 1;
        self.delayBetweenPulseCycles = 0;
        self.annotationColor = [UIColor colorWithRed:244/255.0 green:39/255.0 blue:171/255.0 alpha:1.0];    //[UIColor colorWithRed:0.000 green:0.478 blue:1.000 alpha:1];
