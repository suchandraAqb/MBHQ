                       ...
                       if([DBQuery isRowExist:@"todayGetGrowthDetails" condition:[@"" stringByAppendingFormat:@"UserId ='%@' and AddedDate = '%@'",[NSNumber numberWithInt:[[defaults objectForKey:@"UserID"]intValue]],currentDateStr]]){
                         ...
                         if([dbObject connectionStart]){
                             ...
                             if(![Utility isEmptyCheck:[todayHabitCourseList objectForKey:@"Gratitude"]] || ![Utility isEmptyCheck:[todayHabitCourseList objectForKey:@"Growth"]]){
                                      UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
                                 HabitHackerFirstViewController *controller=[storyboard instantiateViewControllerWithIdentifier:@"HabitHackerFirstView"];
...
//                                   GratitudeListViewController *controller=[storyboard instantiateViewControllerWithIdentifier:@"GratitudeListView"];
                                 AchievementsViewController *controller = [[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"Achievements"];
                                   ...
                                   [Utility localImageSync];
                                    ...
                                    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
                                   HabitHackerFirstViewController *controller=[storyboard instantiateViewControllerWithIdentifier:@"HabitHackerFirstView"];
                                 GratitudeListViewController *c = [storyboard instantiateViewControllerWithIdentifier:@"GratitudeListView"];
...
//                             GratitudeListViewController *controller=[storyboard instantiateViewControllerWithIdentifier:@"GratitudeListView"];
                           ...
                           AchievementsViewController *co=[storyboard instantiateViewControllerWithIdentifier:@"Achievements"];
                           co.isMoveToday = YES;
                             NavigationViewController *navController = [[[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"NavigationViewController"]initWithRootViewController:controller];
                             navController.navigationBarHidden = YES;
                             [self.window setRootViewController:navController];
...
//ah 31.8
//- (MPRemoteCommandHandlerStatus)playTrackCommandSelector{
...
//    if (UIEventSubtypeRemoteControlPlay) {
...
//    
//}
//- (MPRemoteCommandHandlerStatus)pauseTrackCommandSelector {
//    //    NSIndexPath *ip = [NSIndexPath indexPathForRow:appDelegate.activeIndex inSection:0];
//    //    AudioBookTableViewCell *cell = (AudioBookTableViewCell *)[_audioListTable cellForRowAtIndexPath:ip];
//    //    [cell.playPauseButton setSelected:NO];
//    
//    [self.FBWAudioPlayer pause];
//    if (UIEventSubtypeRemoteControlPause) {
//        return MPRemoteCommandHandlerStatusSuccess;
//    }else{
//        return MPRemoteCommandHandlerStatusCommandFailed;
//    }
...
//    [commandCenter.playCommand removeTarget:self action:@selector(togglePlayPauseCommandSelector)];
//    [commandCenter.pauseCommand removeTarget:self action:@selector(skipBackwardEvent:)];
//    [commandCenter.playCommand removeTarget:self action:@selector(skipForwardEvent:)];
...
//                return MPRemoteCommandHandlerStatusSuccess;
//            }];
//            [pauseCommand addTarget:self action:@selector(pauseTrackCommandSelector)];
//
...
//                return MPRemoteCommandHandlerStatusSuccess;
//            }];
//            [playCommand addTarget:self action:@selector(playTrackCommandSelector)];
//
//            MPRemoteCommand *togglePlayPauseCommand = [commandCenter togglePlayPauseCommand];
//            [togglePlayPauseCommand setEnabled:YES];
//            [playCommand addTarget:self action:@selector(togglePlayPauseCommandSelector:)];
//
...
//          [commandCenter.seekForwardCommand addTarget:self action:@selector(playTrackCommandSelector)];
//           [commandCenter.seekBackwardCommand addTarget:self action:@selector(pauseTrackCommandSelector)];
//        }
//        else{
//            commandCenter.playCommand.enabled = true;
//            commandCenter.pauseCommand.enabled = true;
