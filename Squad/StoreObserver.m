/*
 ...
 Abstra/Users/aqbmac4/Downloads/Squad 5/Squad/TokenRecievedDelegate.h/Users/aqbmac4/Downloads/Squad 5/Squad/MyModel.h/Users/aqbmac4/Downloads/Squad 5/Squad/MyModel.m/Users/aqbmac4/Downloads/Squad 5/Squad/ParentViewController.h/Users/aqbmac4/Downloads/Squad 5/Squad/ParentViewController.m/Users/aqbmac4/Downloads/Squad 5/Squad/StoreManager.h/Users/aqbmac4/Downloads/Squad 5/Squad/StoreManager.m/Users/aqbmac4/Downloads/Squad 5/Squad/StoreObserver.h/Users/aqbmac4/Downloads/Squad 5/Squad/StoreObserver.mct:
...
-(void)restore
{
    ...
    //[[SKPaymentQueue defaultQueue] restoreCompletedTransactionsWithApplicationUsername:@"iphoneaqb@gmail.com"];
}
...
{
    [self notifyRemoveActivity:@"restore"];
...
-(void)completeTransaction:(SKPaymentTransaction *)transaction forStatus:(NSInteger)status
{
    ...
    NSLog(@"Transaction Status: %ld",status);
...
//        });
    ...
    if (transaction.error.code != SKErrorPaymentCancelled)
    {
        ...
        [self notifyRemoveActivity:@"removed"];
        //[[NSNotificationCenter defaultCenter] postNotificationName:IAPPurchaseNotification object:self];
    }
}
...
{
    [self notifyRemoveActivity:@"finishDownload"];
...
-(void)notifyRemoveActivity:(NSString *)type{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"removeActivity" object:type];
}
#pragma mark-End
