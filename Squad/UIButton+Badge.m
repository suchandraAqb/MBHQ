...
- (void)badgeInit
{
    ...
    self.badgeBGColor   = [Utility colorWithHexString:@"000000"];//[UIColor redColor];
    self.badgeTextColor = [UIColor whiteColor];
    self.badgeFont      = [UIFont fontWithName:@"Oswald-Regular" size:12.0];//[UIFont systemFontOfSize:12.0];
    self.badgePadding   = 6;
    self.badgeMinSize   = 8;
