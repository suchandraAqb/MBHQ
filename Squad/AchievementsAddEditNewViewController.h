...
@protocol AchievementsAddEditNewDelegate<NSObject>
@optional - (void)didAchievementsBackAction:(BOOL)ischanged;
@end

@interface AchievementsAddEditNewViewController : UIViewController<UITextViewDelegate,UITextFieldDelegate,ReminderDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate, PECropViewControllerDelegate,DropdownViewDelegate,progressViewDelegate,NotesViewDeleagte>
{
    
    id<AchievementsAddEditNewDelegate>achievementDelegate;
}
