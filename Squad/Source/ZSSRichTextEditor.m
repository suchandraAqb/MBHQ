...
- (void)enableTextEditor {
    NSString *js = [NSString stringWithFormat:@"zss_editor.enabled();"];
    [self.editorView stringByEvaluatingJavaScriptFromString:js];
}
- (void)disableTextEditor {
    NSString *js = [NSString stringWithFormat:@"zss_editor.disable();"];
    [self.editorView stringByEvaluatingJavaScriptFromString:js];
}
...
//            sourceFrame.size.height = keyboardHeight - sizeOfToolbar - extraHeight;
